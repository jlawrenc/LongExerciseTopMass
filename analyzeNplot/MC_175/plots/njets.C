...
// ------------>Primitives in pad: p1
   ...
   p1->Draw();
   p1->cd();
   p1->Range(-4.337349,-5.322113e+08,31.80723,3.902883e+09);
   p1->SetFillColor(0);
   p1->SetBorderMode(0);
   p1->SetBorderSize(2);
   p1->SetGridx();
   ...
   frame__3->SetMaximum(3.858532e+09);
   frame__3->SetEntries(186980);
   ...
   mc_stack_2->SetMaximum(3.116507e+09);
   ...
   njets_t#bar{t}_stack_1->SetBinContent(2,2.103779e+09);
   njets_t#bar{t}_stack_1->SetBinContent(3,1.783809e+09);
   njets_t#bar{t}_stack_1->SetBinContent(4,8.075455e+08);
   njets_t#bar{t}_stack_1->SetBinContent(5,2.906662e+08);
   njets_t#bar{t}_stack_1->SetBinContent(6,8.941643e+07);
   njets_t#bar{t}_stack_1->SetBinContent(7,2.403089e+07);
   njets_t#bar{t}_stack_1->SetBinContent(8,6097390);
   njets_t#bar{t}_stack_1->SetBinContent(9,1291212);
   njets_t#bar{t}_stack_1->SetBinContent(10,179335);
   njets_t#bar{t}_stack_1->SetBinError(2,8686555);
   njets_t#bar{t}_stack_1->SetBinError(3,7998743);
   njets_t#bar{t}_stack_1->SetBinError(4,5381843);
   njets_t#bar{t}_stack_1->SetBinError(5,3228827);
   njets_t#bar{t}_stack_1->SetBinError(6,1790838);
   njets_t#bar{t}_stack_1->SetBinError(7,928394.3);
   njets_t#bar{t}_stack_1->SetBinError(8,467648.5);
   njets_t#bar{t}_stack_1->SetBinError(9,215202);
   njets_t#bar{t}_stack_1->SetBinError(10,80201.05);
   njets_t#bar{t}_stack_1->SetEntries(142382);
...
// ------------>Primitives in pad: p2
   ...
   ratioframe__4->SetEntries(186980);
   ...
   Graph_Graph_from_ratio3004->SetMaximum(0.0003439673);
