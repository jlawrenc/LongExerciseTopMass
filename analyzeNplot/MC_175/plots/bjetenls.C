...
// ------------>Primitives in pad: p1
   ...
   p1->Draw();
   p1->cd();
   p1->Range(2.421687,-57.46745,7.240964,422.2613);
   p1->SetFillColor(0);
   p1->SetBorderMode(0);
   p1->SetBorderSize(2);
   p1->SetGridx();
   ...
   frame__7->SetMaximum(417.464);
   frame__7->SetEntries(61714);
   ...
   mc_stack_4->SetMaximum(337.1825);
   ...
   bjetenls_t#bar{t}_stack_1->SetBinContent(3,95.10766);
   bjetenls_t#bar{t}_stack_1->SetBinContent(4,224.6344);
   bjetenls_t#bar{t}_stack_1->SetBinContent(5,274.3216);
   bjetenls_t#bar{t}_stack_1->SetBinContent(6,305.0788);
   bjetenls_t#bar{t}_stack_1->SetBinContent(7,308.0081);
   bjetenls_t#bar{t}_stack_1->SetBinContent(8,275.4891);
   bjetenls_t#bar{t}_stack_1->SetBinContent(9,222.9481);
   bjetenls_t#bar{t}_stack_1->SetBinContent(10,166.8957);
   bjetenls_t#bar{t}_stack_1->SetBinContent(11,113.3358);
   bjetenls_t#bar{t}_stack_1->SetBinContent(12,72.91985);
   bjetenls_t#bar{t}_stack_1->SetBinContent(13,42.51225);
   bjetenls_t#bar{t}_stack_1->SetBinContent(14,23.79207);
   bjetenls_t#bar{t}_stack_1->SetBinContent(15,12.25627);
   bjetenls_t#bar{t}_stack_1->SetBinContent(16,5.409266);
   bjetenls_t#bar{t}_stack_1->SetBinContent(17,2.48844);
   bjetenls_t#bar{t}_stack_1->SetBinContent(18,0.8726903);
   bjetenls_t#bar{t}_stack_1->SetBinContent(19,0.3397004);
   bjetenls_t#bar{t}_stack_1->SetBinContent(20,0.1055624);
   bjetenls_t#bar{t}_stack_1->SetBinContent(21,0.02921628);
   bjetenls_t#bar{t}_stack_1->SetBinError(3,3.287294);
   bjetenls_t#bar{t}_stack_1->SetBinError(4,4.625295);
   bjetenls_t#bar{t}_stack_1->SetBinError(5,4.633359);
   bjetenls_t#bar{t}_stack_1->SetBinError(6,4.425093);
   bjetenls_t#bar{t}_stack_1->SetBinError(7,4.020883);
   bjetenls_t#bar{t}_stack_1->SetBinError(8,3.446987);
   bjetenls_t#bar{t}_stack_1->SetBinError(9,2.809518);
   bjetenls_t#bar{t}_stack_1->SetBinError(10,2.200268);
   bjetenls_t#bar{t}_stack_1->SetBinError(11,1.641741);
   bjetenls_t#bar{t}_stack_1->SetBinError(12,1.190316);
   bjetenls_t#bar{t}_stack_1->SetBinError(13,0.8251837);
   bjetenls_t#bar{t}_stack_1->SetBinError(14,0.5587695);
   bjetenls_t#bar{t}_stack_1->SetBinError(15,0.3628006);
   bjetenls_t#bar{t}_stack_1->SetBinError(16,0.2179069);
   bjetenls_t#bar{t}_stack_1->SetBinError(17,0.1340257);
   bjetenls_t#bar{t}_stack_1->SetBinError(18,0.07205427);
   bjetenls_t#bar{t}_stack_1->SetBinError(19,0.04096833);
   bjetenls_t#bar{t}_stack_1->SetBinError(20,0.02023128);
   bjetenls_t#bar{t}_stack_1->SetBinError(21,0.009297346);
   bjetenls_t#bar{t}_stack_1->SetEntries(54797);
...
// ------------>Primitives in pad: p2
   ...
   ratioframe__8->SetEntries(61714);
   ...
   Graph_Graph_from_ratio3008->SetMaximum(1.055176);
