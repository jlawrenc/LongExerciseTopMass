...
// ------------>Primitives in pad: p1
   ...
   p1->Draw();
   p1->cd();
   p1->Range(-0.7228916,-16797.56,5.301205,123183);
   p1->SetFillColor(0);
   p1->SetBorderMode(0);
   p1->SetBorderSize(2);
   p1->SetGridx();
   ...
   frame__11->SetMaximum(121783.2);
   frame__11->SetEntries(45339);
   ...
   mc_stack_6->SetMaximum(98363.32);
   ...
   nbtags_t#bar{t}_stack_1->SetBinContent(2,88278.91);
   nbtags_t#bar{t}_stack_1->SetBinContent(3,54994.3);
   nbtags_t#bar{t}_stack_1->SetBinError(2,584.2138);
   nbtags_t#bar{t}_stack_1->SetBinError(3,461.2325);
   nbtags_t#bar{t}_stack_1->SetEntries(39651);
...
// ------------>Primitives in pad: p2
   ...
   ratioframe__12->SetEntries(45339);
   ...
   Graph_Graph_from_ratio3012->SetMaximum(0.9903552);
