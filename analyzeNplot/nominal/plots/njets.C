...
// ------------>Primitives in pad: p1
   ...
   p1->Draw();
   p1->cd();
   p1->Range(-4.337349,-3.617601e+09,31.80723,2.652907e+10);
   p1->SetFillColor(0);
   p1->SetBorderMode(0);
   p1->SetBorderSize(2);
   p1->SetGridx();
   ...
   frame__3->SetMaximum(2.622761e+10);
   frame__3->SetEntries(1342224);
   ...
   mc_stack_2->SetMaximum(2.118384e+10);
   ...
   njets_t#bar{t}_stack_1->SetBinContent(2,1.931076e+10);
   njets_t#bar{t}_stack_1->SetBinContent(3,1.627289e+10);
   njets_t#bar{t}_stack_1->SetBinContent(4,7.271855e+09);
   njets_t#bar{t}_stack_1->SetBinContent(5,2.582639e+09);
   njets_t#bar{t}_stack_1->SetBinContent(6,7.976104e+08);
   njets_t#bar{t}_stack_1->SetBinContent(7,2.250296e+08);
   njets_t#bar{t}_stack_1->SetBinContent(8,6.05435e+07);
   njets_t#bar{t}_stack_1->SetBinContent(9,1.563801e+07);
   njets_t#bar{t}_stack_1->SetBinContent(10,3945370);
   njets_t#bar{t}_stack_1->SetBinContent(11,860808);
   njets_t#bar{t}_stack_1->SetBinContent(12,179335);
   njets_t#bar{t}_stack_1->SetBinError(2,2.631765e+07);
   njets_t#bar{t}_stack_1->SetBinError(3,2.415905e+07);
   njets_t#bar{t}_stack_1->SetBinError(4,1.614991e+07);
   njets_t#bar{t}_stack_1->SetBinError(5,9624527);
   njets_t#bar{t}_stack_1->SetBinError(6,5348634);
   njets_t#bar{t}_stack_1->SetBinError(7,2840974);
   njets_t#bar{t}_stack_1->SetBinError(8,1473606);
   njets_t#bar{t}_stack_1->SetBinError(9,748924.9);
   njets_t#bar{t}_stack_1->SetBinError(10,376176.3);
   njets_t#bar{t}_stack_1->SetBinError(11,175711.7);
   njets_t#bar{t}_stack_1->SetBinError(12,80201.05);
   njets_t#bar{t}_stack_1->SetEntries(1297626);
...
// ------------>Primitives in pad: p2
   ...
   ratioframe__4->SetEntries(1342224);
   ...
   Graph_Graph_from_ratio3004->SetMaximum(2.253131e-05);
