...
//=========  (Wed Jan 15 12:07:35 2020) by ROOT version 6.14/09
...
// ------------>Primitives in pad: p1
   ...
   frame__5->SetMaximum(20607.1);
   frame__5->SetEntries(504712);
...
// ------------>Primitives in pad: p2
   ...
   ratioframe__6->SetEntries(504712);
   ...
   Graph_Graph_from_ratio3006->SetMaximum(1.047415);
